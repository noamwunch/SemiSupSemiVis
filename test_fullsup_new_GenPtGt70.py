...
output_path = "./RESULTS/fullsup/rinv0.25sf0.20_BkgGenPtGt70/"
B_path_test = "/gpfs0/kats/users/wunch/semisup_evs/bkg_GenPtGt70/test"
S_path_test = "/gpfs0/kats/users/wunch/semisup_evs/sig_rinv_0.25_mjj_500/test"
B_path = "/gpfs0/kats/users/wunch/semisup_evs/bkg_GenPtGt70/train"
...
if train:
    ...
    invalid = (j1_dat.jet_PT<pt_min) | (j2_dat.jet_PT<pt_min)
