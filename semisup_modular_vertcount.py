...
def main_semisup(B_path, S_path, Btest_path, Stest_path, exp_dir_path, Ntrain=int(1e5), Ntest=int(1e4), sig_frac=0.2,
    ...
    if first_cut_feat == 'multiplicity':
        ...
        model_j1 = jet_vert_classifier()
        model_j2 = jet_vert_classifier()
    else:
        raise ValueError('Unsupported first cut feature')
    ...
    with np.errstate(divide='ignore'):
        ...
        plot_rocs(classifier_dicts=classifier_dicts2, true_lab=event_label_test,
                  save_path=exp_dir_path+'log_ROC2.pdf')
