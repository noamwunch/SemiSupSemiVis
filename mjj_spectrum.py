...
def mjj_dist(y_bkg, y_sig, fig_name, yscale='log', title='', masks=None, pdf=None):
    ...
    hist_dict = dict(histtype='step', align='mid', linestyle=['--', '--', '-'], color=['red', 'blue', 'black'])
    ...
    annot_reg_dict = dict(xy=(0.49, 0.7), xycoords='axes fraction')
    if masks:
    ...
    annot_tot_dict = dict(xy=(0.49, 0.6), xycoords='axes fraction')
