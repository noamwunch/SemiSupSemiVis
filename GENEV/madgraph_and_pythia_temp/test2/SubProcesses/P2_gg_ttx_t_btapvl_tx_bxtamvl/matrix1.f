...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WT)
        FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_MTA
     ...
     $   , ZERO)
      ...
      CALL FFV2_3(W(1,4),W(1,5),GC_100,MDL_MW, FK_MDL_WW,W(1,6))
      CALL FFV2_1(W(1,3),W(1,6),GC_100,MDL_MT, FK_MDL_WT,W(1,5))
      CALL IXXXXX(P(0,6),MDL_MB,NHEL(6),-1*IC(6),W(1,6))
      CALL OXXXXX(P(0,7),MDL_MTA,NHEL(7),+1*IC(7),W(1,3))
      CALL IXXXXX(P(0,8),ZERO,NHEL(8),-1*IC(8),W(1,4))
      CALL FFV2_3(W(1,4),W(1,3),GC_100,MDL_MW, FK_MDL_WW,W(1,7))
      CALL FFV2_2(W(1,6),W(1,7),GC_100,MDL_MT, FK_MDL_WT,W(1,4))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,5),W(1,7),GC_11,AMP(1))
      CALL FFV1_1(W(1,5),W(1,1),GC_11,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,7),W(1,2),GC_11,AMP(2))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,MDL_MT, FK_MDL_WT,W(1,7))
