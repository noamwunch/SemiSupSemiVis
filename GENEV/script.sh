...
qsub -N genevs_bb -t 1:2 arrjob_genev.sh "$settings_madgraph"
cd ..

cd root_to_txt
rm std*
args_root="/gpfs0/kats/users/wunch/SemiSupSemiVis/GENEV/args_root/args_root_bb.sh"
qsub -N root2txt_bb -t 1:2 -hold_jid genevs_bb arrjob_root2txt.sh "$args_root"
cd ..
...
qsub -N genevs_dark_0.5mm_rinv0 -t 1:2 arrjob_genev.sh "$settings_madgraph"
cd ..

cd root_to_txt
rm std*
args_root="/gpfs0/kats/users/wunch/SemiSupSemiVis/GENEV/args_root/args_root_dark_0.5mm_rinv0.sh"
qsub -N root2txt_dark_0.5mm_rinv0 -t 1:2 -hold_jid genevs_dark_0.5mm_rinv0 arrjob_root2txt.sh "$args_root"
cd ..
...
qsub -N genevs_dark_0.25mm_rinv0 -t 1:2 arrjob_genev.sh "$settings_madgraph"
cd ..

cd root_to_txt
rm std*
args_root="/gpfs0/kats/users/wunch/SemiSupSemiVis/GENEV/args_root/args_root_dark_0.25mm_rinv0.sh"
qsub -N root2txt_dark_0.25mm_rinv0 -t 1:2 -hold_jid genevs_dark_0.25mm_rinv0 arrjob_root2txt.sh "$args_root"
cd ..